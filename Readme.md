...
```bash
# If using OpenAI (recommended with openai SDK)
...
```js
// Example (pseudocode, adjust to your actual implementation)
import OpenAI from "openai";

const client = new OpenAI({
  apiKey: process.env.OPENAI_API_KEY,
  // no custom baseURL for normal OpenAI usage
});
```

> Do **not** mix Gemini endpoints with the OpenAI SDK.  
> If you want Gemini, use the official Gemini SDK instead.
...
````// filepath: /Users/karanchoudhary/Developer/Persona AI/README.md
# ☕ Chai With AI Buddies
